...
struct CameraPhotoAsset: Identifiable {
...
extension CameraPhotoAsset: Equatable {
    static func ==(lhs: CameraPhotoAsset, rhs: CameraPhotoAsset) -> Bool {
        (lhs.identifier == rhs.identifier) && (lhs.isFavorite == rhs.isFavorite)
    }
}

extension CameraPhotoAsset: Hashable {
